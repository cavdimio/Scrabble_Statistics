module.exports = 
    ...
    }, 
    {
      ...
      player2 : {
        name: "Christos",
        scores: [ 24, 30, 30, 5, 26, 25, 16, 8, 9, 10, 12, 15, 14, 16, 18, 15, -6]
      },
    },
    {
      player1 : {
    ...
    }, 
    {
        ...
        player2 : {
          name: "Christos",
          scores: [ 17, 24, 10, 8, 18, 13, 8, 13, 17, 9, 14, 46, 7, 12, 33, 10, 4, 4, -2]
        },
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 14, 4, 12, 18, 14, 22, 16, 6, 26, 9, 21, 24, 4, 2, 12, 5, 28, -3]
        }, 
        player2 : {
          name: "Christos",
    ...
    }, 
    {
        ...
        player2 : {
          name: "Christos",
          scores: [ 18, 8, 11, 12, 57, 22, 11, 14, 7, 84, 13, 6, 12, 9, 9, 11, 3, 10, 11, 10, 10, -5]
        },
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 9, 10, 23, 34, 10, 12, 7, 18, 10, 14, 17, 14, 42, 9, 8, 7, 5, 13]
        }, 
        player2 : {
          name: "Christos",
          scores: [ 6, 14, 34, 16, 18, 30, 13, 11, 14, 21, 3, 16, 18, 11, 9, 14, 5, -10]
        },
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 3, 18, 18, 14, 13, 13, 13, 16, 9, 16, 39, 7, 14, 24, 7, 13, 12, 4, 10, 4, 2, -2]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 15, 6, 30, 14, 15, 13, 7, 17, 11, 9, 8, 26, 7, 12, 12, -6]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 23, 26, 45, 11, 5, 8, 12, 6, 7, 10, 12, 11, 12, 8, 3, 9, 8, 5, -10]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 16, 8, 7, 96, 20, 19, 14, 14, 15, 25, 41, 6, 11, 7, 8, 6, -2]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 6, 18, 12, 14, 26, 12, 18, 5, 28, 28, 16, 7, 15, 16, 9, 6, 3, 8, -2]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        ...
        player2 : {
          name: "Christos",
          scores: [ 61, 15, 14, 39, 13, 48, 12, 17, 30, 19, 28, 11, 21, 6, 6, -4]
        },
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 16, 15, 36, 18, 16, 14, 7, 26, 20, 11, 12, 7, 14, 5, 6, 4, 5, 2, -4]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        ...
        player2 : {
          name: "Christos",
          scores: [ 12, 19, 36, 12, 9, 4, 6, 90, 18, 29, 16, 18, 18, 12, 15, 5, -3]
        },
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 74, 7, 28, 10, 16, 12, 17, 3, 2, 2, 5, 3, 28, 9, 4, 12, 2, 8, 5, 6, -8]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 5, 12, 9, 60, 14, 12, 30, 17, 14, 16, 4, 18, 37, 13, 6, 7, -1]
        }, 
        player2 : {
          name: "Christos",
    ...
    },
    {
        player1 : {
          name: "Konstantina", 
          scores: [ 40, 9, 11, 12, 30, 30, 17, 11, 8, 34, 9, 18, 8, 13, 8, -3]
        }, 
        player2 : {
          name: "Christos",
