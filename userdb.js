...
module.exports =
    ...
    Users = [
        {
            _id: userIDChristos, //TODO unique username, email
            username: "cavdimio",
            password: "1234",
            name: "Christos",
            friends: [userIDKonstantina, userIDAfroditi, userIDThanos],
            dummyNames: ["MyDog", "MyGradma"],
            insertedGames: [{
                    _id: "55348611a56c10449ab80a4f",
                    scores: [22, 18, 10, 10, 10, 36, 11, 23, 51, 6, 6, 26, 3, 6, 5, 2, -3, 12],
                    opponents: [{
                            _id: userIDKonstantina,
                            name: "Konstantina",
        ...
        },
        {
            ...
            password: "3456",
            name: "Konstantina",
            friends: [userIDChristos, userIDAfroditi, userIDThanos],
            dummyNames: ["Dad", "Mom"],
            insertedGames: [{
        ...
        },
        {
            ...
            password: "7890",
            name: "Thanos",
            friends: [ userIDKonstantina, userIDChristos],
            dummyNames: [],
            insertedGames: [],
        },
        {
